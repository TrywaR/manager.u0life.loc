...
<div class="main_content">
  ...
  <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
      <button <?=$oLock->get_attr('TimesCostsAnalyticYear', 'onclick="year_show()" id="pills-yaer-tab" data-bs-toggle="pill" data-bs-target="#pills-yaer" type="button" role="tab" aria-controls="pills-yaer" aria-selected="false"')?> class="nav-link elem_lock">
        <?=$oLang->get('Year')?>
        <?=$oLock->get('TimesCostsAnalyticYear')?>
      </button>
    </li>
  </ul>

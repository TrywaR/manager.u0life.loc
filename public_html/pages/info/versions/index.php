    ...
    <div class="row">
      <div class="col col-12 col-xl-4 mb-4">
        <div id="list-example" class="list-group" style="height: calc(75vh); overflow-y: auto;">
          <a class="list-group-item list-group-item-action active" href="#list-item-5_6_4">5.6.4 Scroll fix</a>
          ...
          <a class="list-group-item list-group-item-action" href="#list-item-5_5_2">5.5.2 Projects</a>
      ...
      <div class="col col-12 col-xl-8">
        <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0" style="height: calc(75vh); overflow-y: auto;">
          <div class="pt-2 pb-2">
            <h2 id="list-item-5_6_4">5.6.4 Scroll fix</h2>
            <ol>
              <li>
                Исправлена работа скролла
              </li>
            </ol>

            <h2 id="list-item-5_6_3">5.6.3 Prelist elements</h2>
            <ol>
              <li>
                Возможность добавлять элементы списков и менять их статус
              </li>
            </ol>
            ...
            <ol>
              <li>
                Добавлены страницы пользователей, теперь вашу страницу могут видеть другие пользователи если указать в настройках профиля "Публичная страница"
              </li>
            </ol>

            <h2 id="list-item-5_5_5">5.5.5 Tasks micro</h2>
            <ol>
              <li>
                Улучшена навигация по задачам, проектам и клиентам
              </li>
              <li>
                Добавлены новые поля для клиентов и фильтрация по ним
              </li>
            </ol>

            <h2 id="list-item-5_5_4">5.5.4 MEGA Currency</h2>
            <ol>
              <li>
                Вывод статистики в валюте
              </li>
              <li>
                Поддержывается 164 валюты
              </li>
            </ol>

            <h2 id="list-item-5_5_3">5.5.3 Currency</h2>
            <ol>
              <li>
                Возможность задавать валюту пользователя
              </li>
              <li>
                Высчитывается валюта пользователя в картах
              </li>
              <li>
                Высчитывается валюта пользователя в списке трат и поступлений
              </li>
            </ol>
            ...
            <ol>
              <li>
                Добавлен функционал уведомлений на дашборде (упращённый)
              </li>
              <li>
                В статистике за день теперь учитываются зачисления
              </li>
              <li>
                Обновленна и улучшена документация
              </li>
              <li>
                На дашборде показывается баланс с учётом кредиток
              </li>
              <li>
                Добавлена ознокомительная инфомрация если данные не заполненны
              </li>
              <li>
                При обновлении карт они автоматически обновляются в списке
              </li>
              <li>
                Теперь авторизации происходит сразу после регистрации
              </li>
              <li>
                Исправленные ошибки
              </li>
            ...
            <h2 id="list-item-5_5_0">5.5.0 Clients</h2>
            <ol>
              <li>
              ...
              <li>
                Небольшие стиливые доработки
              </li>
              <li>
                Улучшена система подсчёта баланса карт
              </li>
            </ol>
            ...
            <ol>
              <li>
                Добавлена страница с данными по платежам по подпискам
              </li>
            </ol>

            <h2 id="list-item-5_4_7">5.4.7 Hello world</h2>
            <ol>
              <li>
                Улучшена система доступов и достижений
              </li>
              <li>
                Добавлена приветсвенная страница, в кратце объясняющая функционал
              </li>
              <li>
                Добавлена страница с описаниями возможностей при получении полного функционала
              </li>
              <li>
                Небольшие стилевые изменения
              </li>
            ...
            <ol>
              <li>
                Обновлена система масовых изменений
              </li>
              <li>
                Удаление элементов перенесено, и появляется при выборе элемента в списке
              </li>
              <li>
            ...
            <ol>
              <li>
                Исправлена ошибка с появлением кнопок добавления данных
              </li>
              <li>
                Исправлена работа карты "Наличные"
              </li>
              <li>
                У карт добавлена "Активность", тоесть возможность их временно отключать
              </li>
              <li>
                Исправлена доступность к премиум функционалу
              </li>
              <li>
                Изменены выпадающие списки, теперь в них есть поиск, и отображение цвета
              </li>
            </ol>

            <h2 id="list-item-5_4_1">5.4.12 Mobile friendly 2</h2>
            <ol>
              <li>
                Обновлён логотип
              </li>
              <li>
                Небольшие стиливые изменения для светлой темы
              </li>
              <li>
                Статистика по расходам и доходам времени и денег за год, ограничина в зависимости от роли пользователя
              </li>
              <li>
                Поравлены оступы в счётчиках с цифрами
              </li>
              <li>
                Исправлена ошибка с восстановлением пароля по почте
              </li>
              <li>
                В статистиках денег и времени снова добавленны суммы
              </li>
              <li>
                В статистиках денег и времени добавленны списки категорий с суммами
              </li>
            </ol>

            <h2 id="list-item-5_4_0">5.4.0 Mobile friendly start</h2>
            <ol>
              <li>
                Кнопка "Сохранить" заменена на "ОК", сохраняет изменения и закрывает модальное окно
              </li>
              <li>
                Добавлена кнопка "Копировать"
              </li>
              <li>
                Убраны названия по умолчанию
              </li>
              <li>
                Добавлены категории "Дом", "Здоровье", "Одежда"
              </li>
              <li>
                В фильтрах теперь скрываются лишние категории
              </li>
            </ol>

            <h2 id="list-item-5_3_9">5.3.9 u0life 4</h2>
            <ol>
              <li>
